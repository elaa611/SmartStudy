...
class _GenerateSummaryScreenState extends State<GenerateSummaryScreen> {
  ...
  // ============================================================
  // ÉTAPE 3 : appeler l'Edge Function Supabase pour générer le résumé
  // ============================================================
  Future<void> _genererResume() async {
    ...
    try {
      ...
      final summaryId = data['summary_id'] as String;
      ...
      _showError('Impossible de générer le résumé : $e');
    } finally {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'The summary will be generated only from the selected courses.',
            style: TextStyle(
              fontSize: 12, 
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Select your course materials and let AI extract the core concepts.',
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: _generationEnCours ? null : _genererResume,
                  ...
                  label: Text(
                    _generationEnCours ? 'Analyzing your courses...' : 'Generate Summary',
